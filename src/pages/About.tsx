    ...
    className="container max-w-4xl mx-auto py-12 sm:py-20 px-2 sm:px-6 bg-gradient-to-br from-violet-50 via-white to-sky-50 rounded-3xl shadow-2xl mt-8 mb-12 border-0"
      ...
      >
        ...
        <section className="mb-10" aria-labelledby="about-history">
          <div className="bg-white/95 rounded-2xl shadow-md border border-sky-100 p-7 transition-all duration-200 hover:shadow-lg hover:-translate-y-1 group">
        ...
        <section className="mb-10" aria-labelledby="about-partner">
          <div className="bg-white/95 rounded-2xl shadow-md border border-sky-100 p-7 transition-all duration-200 hover:shadow-lg hover:-translate-y-1 group">
            ...
            <div className="flex flex-wrap gap-3 sm:gap-5 leading-tight">
              ...
              <span className="bg-sky-50 text-sky-500 border border-sky-200 px-5 py-2 rounded-full text-base font-semibold shadow-sm">LG CNS</span>
              <span className="bg-sky-50 text-sky-500 border border-sky-200 px-5 py-2 rounded-full text-base font-semibold shadow-sm">네이버클라우드</span>
              <span className="bg-sky-50 text-sky-500 border border-sky-200 px-5 py-2 rounded-full text-base font-semibold shadow-sm">KT</span>
            </div>
          </div>
        </section>
        {/* 오시는 길 */}
