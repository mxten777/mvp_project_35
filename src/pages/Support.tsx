...
export default function Support() {
  ...
  <h3 className="text-xl sm:text-2xl font-bold mb-4 text-sky-700">1:1 문의</h3>
        <form
          className="flex flex-col gap-5 bg-white/95 rounded-2xl shadow-md border border-sky-100 p-7 leading-relaxed transition-all duration-200 hover:shadow-lg hover:-translate-y-1 group"
          aria-label="1:1 문의 폼"
        >
      ...
      <div className="mb-12">
  <div className="bg-white/95 rounded-2xl shadow-md border border-sky-100 p-7 flex flex-col gap-2 transition-all duration-200 hover:shadow-lg hover:-translate-y-1 group">
